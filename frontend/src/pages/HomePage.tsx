  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-2xl px-4 sm:px-8 lg:px-12 pb-24">
        ...
        {video.description && (
          <p className="mt-3 line-clamp-3 max-w-md text-[15px] leading-relaxed text-gray-300/90">
            {video.description}
          </p>
        )}
        ...
        <div className="mt-6 flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 rounded px-9 py-3 text-[15px] font-bold text-black shadow-lg transition-all hover:bg-gray-100 active:scale-95"
          ...
          <button
            onClick={onSeeMore}
            className="flex items-center gap-2 rounded border border-white/30 bg-white/10 px-7 py-3 text-[15px] font-semibold text-white backdrop-blur-sm transition-all hover:bg-white/20"
          >
            <Info size={20} />
            See More
          </button>
          {showTrailer && video.manifest_url && (
            <button
              ...
              className="ml-2 flex h-11 w-11 items-center justify-center rounded-full border border-white/30 bg-black/40 text-white backdrop-blur-sm transition-all hover:bg-black/60"
